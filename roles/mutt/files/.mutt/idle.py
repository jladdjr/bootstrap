...
IDLE_FOLDERS = [
    ("Jim", "jladdjr@gmail.com", "INBOX", 'imap.gmail.com'),
    ("Jim", "jladdjr@gmail.com", "Sent", 'imap.gmail.com'),

    ("RH", "jladd@redhat.com", "INBOX"),
]
...
def get_keychain_pass(account=None, server='imap.gmail.com'):
    ...
    command = "sudo -u vagrant %(security)s -v %(command)s -g -a %(account)s -s %(server)s %(keychain)s" % params
...
if __name__ == '__main__':
    return  # TODO - TURNING THIS INTO A NO-OP; NEED TO ADAPT THIS TO CENTOS
