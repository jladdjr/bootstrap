...
;; Default parameters for mailbox.org
(setq mu4e-sent-folder "/Sent"
...
(defun jl/sold-art (buyer sale-description sale-price shipping-cost)
  ...
  (setq jl-self-employment-taxes (ftruncate (* 0.15 jl-income-after-shipping)))
  (setq jl-net-income (- jl-income-after-shipping jl-self-employment-taxes))
  (setq jl-self-employment-taxes (number-to-string jl-self-employment-taxes))
